...
async def get_directions(origin: str, destination: str, mode: str="driving") -> Optional[Dict[str, Any]]:
    ...
    Returns:
        dictionary of steps along with total distance and total duration
    """
    try:
        assert_mode(mode)
...
async def get_distance(origin: str, destination: str, mode: str="driving") -> Optional[Dict[str, Any]]:
    ...
    Returns:
        dictionary of total distance, total travel time duration, and mode of travel
    """
    try:
        assert_mode(mode)
    except AssertionError as e:
...
async def get_geocode(address: str) -> Optional[Dict[str, Any]]:
    ...
    Returns:
        dictionary with the geocode (latitude & longitude) of the address
    """
...
async def find_place(input: str, input_type: str="textquery", fields: Optional[List[str]] = None) -> Dict[str, Any]:
    ...
    Returns:
        dictionary of with basic information of the top result based on input query. basic information inclulde:
        - name
        - place_id
        - address
...
async def place_nearby(location: dict, radius: int, place_type: str) -> Optional[Dict[str, Any]]:
    ...
    Returns:
        dictionary of establishment names (key) and their place_id (value)
    """
...
async def place_details(place_id: str, fields: Optional[List[str]] = None) -> Dict[str, Any]:
    ...
    Returns:
        dictionary of with details of provided place. details inclulde:
        - name
        - address
        - phone number
        - website
